...
namespace TicTacToe
{
    internal static class Program
    {
        ...
        public static int programmZustand;
        ...
        private static void Main()
        {
            ...
            do
            {
                ...
                if (programmZustand == 2) ResetBoard2();
        ...
        {
            var r = new Random();
            var line1 = " U-N-E-N-T-S-C-H-I-E-D-E-N ";
            var ausgabe = "";
            for (var zeichen = 0; zeichen < line1.Length; zeichen = r.Next(0, line1.Length))
            {
                zeichen++;
                ...
                if (zeichen % 2 == 0)
                {
                    ...
                    if (zeichen % 3 == 0) line1[zeichen].ToString().Replace('-', '~');
                }

                if (zeichen == line1.Length) break;
        ...
        private static void ResetBoard()
        {
            ...
            for (var row = 0; row < 3; row++)
            {
                ...
                Console.Write("-------");
                for (var column = 0; column < 3; column++) OutputSign(column, row);
            }
        }
        ...
        {
            var isSelected = Lesekopf.X == column && Lesekopf.Y == row;
